...
import 'package:iman_invest/feature/shop/presentation/home_page/widgets/banners/partners_small_banner.dart';
import 'package:iman_invest/feature/shop/presentation/home_page/widgets/banners/partners_small_banner_shimmer.dart';
    ...
    return SingleChildScrollView(
      ...
      child: BlocBuilder<SmallMerchantsBloc, SmallMerchantState>(
        builder: (context, state) {
          if (state is InitialSmallMerchants ||
              state is LoadingSmallMerchants) {
            return Row(
              children: [
                ConstrainedBox(
