...
import 'package:iman_invest/feature/shop/presentation/map_screen/widgets/small_container/small_container.dart';
        ...
        children: [
          ...
          Row(
            children: [
              SmallContainer(
                  isKm: true,
                  text: merchant.address.distance.toStringAsFixed(1),
